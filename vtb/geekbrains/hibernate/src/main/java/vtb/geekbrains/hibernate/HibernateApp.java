...
public class HibernateApp {
    public static void main(String[] args) {
        ...
        try {
            ...
            Reader readerIlya = new Reader();
            readerIlya.setName("Ilya");
            session.save(readerIlya);

            Reader readerInna = new Reader();
            readerInna.setName("Inna");
            session.save(readerInna);
            ...
            book.setReaders(Arrays.asList(readerInna, readerIlya));
            session.save(book);
