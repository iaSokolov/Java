package vtb.geekbrains.example;
...
public class MainApp {
    ...
    public static void connect() throws SQLException {
        try {
            ...
            connection = DriverManager.getConnection("jdbc:sqlite:/home/ilya/snap/dbeaver-ce/95/.local/share/DBeaverData/workspace6/.metadata/sample-database-sqlite-1/Chinook.db");
